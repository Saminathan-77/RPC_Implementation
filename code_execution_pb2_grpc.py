...
import code_execution_pb2 as code__execution__pb2
...
if _version_not_supported:
    raise RuntimeError(
        ...
        + f' but the generated code in code_execution_pb2_grpc.py depends on'
...
def add_CodeExecutionServiceServicer_to_server(servicer, server):
    ...
    generic_handler = grpc.method_handlers_generic_handler(
            'CodeExecutionService', rpc_method_handlers)
    server.add_generic_rpc_handlers((generic_handler,))
    server.add_registered_method_handlers('CodeExecutionService', rpc_method_handlers)
